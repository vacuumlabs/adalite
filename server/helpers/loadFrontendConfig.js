...
function getBlockchainExplorerUrlForFrontend() {
  return process.env.CARDANOLITE_ENABLE_MOCK_SERVER === 'true'
    ? `http://localhost:${process.env.PORT}`
    : process.env.CARDANOLITE_BLOCKCHAIN_EXPLORER_URL
}

module.exports = {
  CARDANOLITE_BLOCKCHAIN_EXPLORER_URL: getBlockchainExplorerUrlForFrontend(),
