  ...
  const addressesAndResponses = {
    ...
    'DdzFFzCqrhswQUeSvvYbArL3XHAnnk6VpgEgY6KMEi9fE8sSDPPK51FqLkNzGYf6Z9H7CfLrLhwqoGu4HTVvpWV5WwyvQyd3rrkuePSV': {
      Right: {
        ...
        caType: 'CPubKeyAddress',
        caTxNum: 1,
        caBalance: {getCoin: '750000'},
        caTxList: [
          {
            ctbId: '3b8573d901522d73114b1c9671698d36b42931c863540fc699a636d3d93a1d68',
            ctbTimeIssued: 1519820491,
            ctbInputs: [
              [
                'DdzFFzCqrhswXkREAGRUQRGm3fYnhiujfFsXELpP3FDfSA7atExtvqBuWSk8C5PwD9PnDF7qXJjs9yX48QpkqRVgV4YCfuiVAZN2rEVF',
                {getCoin: '115078'},
              ],
              [
                'DdzFFzCqrhtAThjMBZNSbed3Dw7GmsEprFphaiasLVvCubwJ5oyfzntR9XDAAT8hCDmuAs2wCxXntcrQvxqsqBboiuCrHSApJnN8XebJ',
                {getCoin: '821151'},
              ],
            ],
            ctbOutputs: [
              [
                'DdzFFzCqrhsoggT7JpYS5HeB4BXW5RP2gq8U4pSMmNkREGrby187nbeVDiXTHBAssvHHmVdf7xSRMnAxtR3yHLWqP4GVQqWcsMtVLM4R',
                {getCoin: '7468'},
              ],
              [
                'DdzFFzCqrhswQUeSvvYbArL3XHAnnk6VpgEgY6KMEi9fE8sSDPPK51FqLkNzGYf6Z9H7CfLrLhwqoGu4HTVvpWV5WwyvQyd3rrkuePSV',
            ...
            ctbInputSum: {getCoin: '936229'},
            ctbOutputSum: {getCoin: '757468'},
          },
        ],
      },
    },
...
describe('test private key derivation', () => {
  ...
  const expectedSecret1 =
    ''
  ...
  const expectedSecret2 =
    ''
  ...
  const expectedSecret3 =
    ''
...
describe('test address generation from secret key', () => {
  ...
  const expectedAddress3 =
    'DdzFFzCqrhtBxUBQBKEUmVNYUQnnzgh46BhnxXnp4arQV2NF47gVqWpkFfSxnTmbjcznVrFVGquXAkaDwjT8AgBEZZQJvfZwtpox9czm'
...
describe('test transaction serialization', () => {
  ...
  it('should properly serialize transaction inner body', async () => {
    const utx = await wallet.prepareUnsignedTx(
      'DdzFFzCqrhsgPcpYL9aevEtfvP4bTFHde8kjT3acCkbK9SvfC9iikDPRtfRP8Sq6fsusNfRfm7sjhJfo7LDPT3c4rDr8PqkdHfW8PfuY',
      47
    )
    ...
    const expectedUtxSerialized =
      ''
  ...
  it('should properly compute transaction hash', async () => {
    ...
    const expectedTxHash = 'b0a258bd8369ab409eab45c216fcddbd437821e2dff471ccb8b9f6e29e6ae29f'
  ...
  it('should properly compute transaction witnesses', async () => {
    ...
    const expectedWitnessesSerialized =
      ''
  ...
  it('should properly serialize the whole transaction', async () => {
    ...
    const expectedTxBody =
      ''
