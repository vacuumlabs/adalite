...
const {generateMnemonic, mnemonicToHdNode} = require('../../wallet/mnemonic')
...
describe('hdNode derivation from mnemonic', () => {
  ...
  const generatedHdNode1 = hdNodeToString(mnemonicToHdNode(mnemonicString1))
  ...
  const generatedHdNode2 = hdNodeToString(mnemonicToHdNode(mnemonicString2))
