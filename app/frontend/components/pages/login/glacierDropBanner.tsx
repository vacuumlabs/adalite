...
const GlacierDropBanner = () => {
  ...
  if (glacierDropTokensAllocation.total.lte(0) || !isVisible) {
    return null
  }
  ...
  return (
    ...
    >
      <div style={{flex: 1}}>
        ...
        <b>{printTokenAmount(glacierDropTokensAllocation.total, 6)} NIGHT</b> from{' '}
        {glacierDropTokensAllocation.accounts} of your accounts in the Glacier Drop Midnight token
        distribution! Learn more{' '}
        <a
          href="https://www.midnight.gd/faq"
          target="_blank"
